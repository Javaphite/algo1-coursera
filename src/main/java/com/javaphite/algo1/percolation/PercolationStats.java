...
public class PercolationStats {
    ...
    private static final String MEAN_MESSAGE_TEMPLATE = "mean = %f\n";

    private static final String STD_DEVIATION_MESSAGE_TEMPLATE = "stddev = %f\n";

    private static final String CONFIDENCE_MESSAGE_TEMPLATE = "95%% confidence interval = [%f, %f]\n";
